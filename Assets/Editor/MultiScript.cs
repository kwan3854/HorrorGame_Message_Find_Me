...
public class MultiScript : EditorWindow
{
    ...
    private void addScriptToObjects()
    {
        if (Selection.gameObjects.Length > 0)
        {
            ...
            {
                UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(o, "Assets/Editor/MultiScript.cs (54,17)", s.name);
    ...
    private void recursiveAdd(GameObject o)
    {
        ...
        {
            UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(t.gameObject, "Assets/Editor/MultiScript.cs (68,13)", s.name);
